    ...
    <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-8">
      ...
      <div className="space-y-3 mb-6">
        <button
          ...
          className="w-full py-3 px-4 border-2 border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition flex items-center justify-center gap-3"
        >
